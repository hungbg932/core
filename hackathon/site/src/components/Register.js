...
export default function ({ navigate }) {
    ...
    const [{ data: result = {}, loading }, doRegister] = useAxios({
        url:  `${APPCONFIG.apiUri}auth/register`,
        method: "POST",
        data: {
            name, email, password
        }
            ...
            <Container maxWidth="md" className={classes.pageContainer}>
                <Paper elevation={3}>
                    <form className={classes.boxWrapper} onSubmit={onRegisterClick}>
                        <Typography className={classes.textWelcome} color="textSecondary" variant="subtitle1">Register account!</Typography>
